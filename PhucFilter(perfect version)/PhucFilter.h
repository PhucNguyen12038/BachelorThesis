...
#ifndef PHUCFILTERSPLUGIN_H
#define PHUCFILTERSPLUGIN_H
#include <QObject>
...
class PhucPlugin : public QObject, public MeshFilterInterface
{
	Q_OBJECT
...
public:
        ...
        virtual QString pluginName(void) const { return "PhucPlugin"; }
